...
>>>>>>> dd9a8469ccc2a40a9d5ed4f1e0f55548c6370fb5
=======
...
>>>>>>> 39f4d7568006d1ca836076d34d0d21fdfb8da747
...
The interactive choropleth dashboard created on the community Tableau site enables a user to hover over maps of the contiguous United States and obtain county-level data. Five individual choropleths have been engineered to display to the user how each county differs by population vs. median income, water usage for irrigation, total domestic use of water, total public supply of water, and total use of water. The user is prompted to select a state, county, and map view to visualize various data sets. This allows for visual comparison between states and counties and for the user to dive deeper into their regional water usage data.

Once the preceding charts and dashboards had been created, they were coded into an interactive Streamlit app. This gives the user the opportunity to dive deeper into the data regarding their county of interest. Starting at an "About" page, the user is given background information pertaining to the project, as well as the purpose and a summary of the insights and findings. The user then has the ability to look at concise visualizations of categorized water usage in the continuous United States, climate data regarding temperature and drought conditions, and income data nationwide. Then, the interactive choropleths mentioned above are available for the user to navigate. On the following two pages, the user is prompted to select their state and county, and is then presented with information and visualizations pertaining to water usage, climate, and income demographics. For the sake of transparency, the data citations, as well as the full data frame and data dictionary, have been provided on the first and last pages.
