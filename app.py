...
page = st.sidebar.selectbox(
    'Page',
    ('About', 'Exploratory Data Analysis', 'Choropleths', 'Clusters')
)

if page == 'About':
    st.subheader('About this project')
    st.write('''
This is a Streamlit app that hosts our Water Usage analysis.
...
Using numerical data from [sources], we have created the following visualizations and trained the following models.
...
conditions.
    ...
    image1 = Image.open('EDA/Water_Usage_by_Cat.png')
    st.image(image1, 
             caption=' ', 
             width=750,
             channels="RGB", 
...
southwest have more drought days than the rest of the country.
    ...
    image2 = Image.open('EDA/moderate_drought.png')
    st.image(image2, 
             caption=' ', 
             width=750,
             channels="RGB", 
    ...
    image3 = Image.open('EDA/tmean_c.png')
    st.image(image3, 
             caption=' ', 
             width=750,
             channels="RGB", 
    ...
    image4 = Image.open('EDA/median_household_income.png')
    st.image(image4, 
             caption=' ', 
             width=750,
             channels="RGB", 
...
elif page == 'Choropleths':
    
    st.title('What did we find?')

    state = st.selectbox('Select your state', ('AL', 'AK', 'AZ', 'AR', 'CA', 'CO', 'CT', 'DE',
                                'DC', 'FL', 'GA', 'HI', 'ID', 'IL', 'IN', 'IA', 'KS', 'KY', 'LA',
                                'ME', 'MD', 'MA', 'MI', 'MN', 'MS', 'MO', 'MT', 'NE', 'NV', 'NH', 
                                'NJ', 'NM', 'NY', 'NC', 'ND', 'OH', 'OK', 'OR', 'PA', 'RI', 'SC', 
                                'SD', 'TN', 'TX', 'UT', 'VT', 'VA', 'WA', 'WV', 'WI', 'WY'))
    if state == 'AL':
        county = st.selectbox('Select your county', ('Autauga', 'Baldwin', 'Barbour', 'Bibb', 'Blount',
        ...
        county = st.selectbox('Select your county', ('Aleutians East', 'Aleutians West', 'Anchorage',
        ...
        county = st.selectbox('Select your county', ('Apache', 'Cochise', 'Coconino', 'Gila', 'Graham',
                                'Greenlee', 'La Paz', 'Maricopa', 'Mohave', 'Navajo', 'Pima', 'Pinal',
                                'Santa Cruz', 'Yavapai', 'Yuma'))

    elif state == 'CA':
        county = st.selectbox('Select your county', ('Alameda', 'Alpine', 'Amador', 'Butte', 'Calaveras',
        ...
        county = st.selectbox('Select your county', ('Adams', 'Alamosa', 'Arapahoe', 'Archuleta', 'Baca', 'Bent',
        ...
        county = st.selectbox('Select your county', ('Fairfield', 'Hartford', 'Litchfield', 'Middlesex',
                                'New Haven', 'New London', 'Tolland', 'Windham'))

    elif state == 'DE':
        county = st.selectbox('Select your county', ('Kent', 'New Castle', 'Sussex'))

    elif state == 'DC':
        county = st.selectbox('Select your county', ('District of Columbia'))

    elif state == 'FL':
        county = st.selectbox('Select your county', ('Alachua', 'Baker', 'Bay', 'Bradford', 'Brevard', 'Broward',
        ...
        county = st.selectbox('Select your county', ('Appling', 'Atkinson', 'Bacon', 'Baker', 'Baldwin', 'Banks',
        ...
        county = st.selectbox('Select your county', ('Hawaii', 'Kahoolawe', 'Kauai', 'Lanai', 'Maui', 'Molokai', 'Niihau', 'Oahu'))

    elif state == 'ID':
        county = st.selectbox('Select your county', ('Ada', 'Adams', 'Bannock', 'Bear Lake', 'Benewah', 'Bingham',
        ...
        county = st.selectbox('Select your county', ('Adams', 'Alexander', 'Bond', 'Boone', 'Brown', 'Bureau',
        ...
        county = st.selectbox('Select your county', ('Adams', 'Allen', 'Bartholomew', 'Benton', 'Blackford',
        ...
        county = st.selectbox('Select your county', ('Adair', 'Adams', 'Allamakee', 'Appanoose', 'Audubon', 'Benton',
        ...
        county = st.selectbox('Select your county', ('Allen', 'Anderson', 'Atchison', 'Barber', 'Barton', 'Bourbon', 'Brown',
        ...
        county = st.selectbox('Select your county', ('Adair', 'Allen', 'Anderson', 'Ballard', 'Barren', 'Bath', 'Bell', 'Boone', 
        ...
        county = st.selectbox('Select your county', ('Acadia', 'Allen', 'Ascension', 'Assumption', 'Avoyelles', 'Beauregard', 'Bienville', 
        ...
        county = st.selectbox('Select your county', ('Androscoggin', 'Aroostook', 'Cumberland', 'Franklin', 'Hancock', 'Kennebec', 
                                'Knox', 'Lincoln', 'Oxford', 'Penobscot', 'Piscataquis', 'Sagadahoc', 'Somerset', 'Waldo', 'Washington',
                                'York'))

    elif state == 'MD':
        county = st.selectbox('Select your county', ('Allegany', 'Anne Arundel', 'Baltimore', 'Baltimore City', 'Calvert', 'Caroline', 
        ...
        county = st.selectbox('Select your county', ('Barnstable', 'Berkshire', 'Bristol', 'Dukes', 'Essex', 'Franklin', 'Hampden', 
                                'Hampshire', 'Middlesex', 'Nantucket', 'Norfolk', 'Plymouth', 'Suffolk', 'Worcester'))

    elif state == 'MI':
        county = st.selectbox('Select your county', ('Alcona', 'Alger', 'Allegan', 'Alpena', 'Antrim', 'Arenac', 'Baraga', 'Barry', 
        ...
        county = st.selectbox('Select your county', ('Aitkin', 'Anoka', 'Becker', 'Beltrami', 'Benton', 'Big Stone', 'Blue Earth', 'Brown', 
        ...
        county = st.selectbox('Select your county', ('Adams', 'Alcorn', 'Amite', 'Attala', 'Benton', 'Bolivar', 'Calhoun', 'Carroll', 
        ...
        county = st.selectbox('Select your county', ('Adair', 'Andrew', 'Atchison', 'Audrain', 'Barry', 'Barton', 
        ...
        county = st.selectbox('Select your county', ('Beaverhead', 'Big Horn', 'Blaine', 'Broadwater', 'Carbon', 'Carter', 'Cascade', 
        ...
        county = st.selectbox('Select your county', ('Adams', 'Antelope', 'Arthur', 'Banner', 'Blaine', 'Boone', 'Box Butte', 'Boyd', 
        ...
        county = st.selectbox('Select your county', ('Carson City', 'Churchill', 'Clark', 'Douglas', 'Elko', 'Esmeralda', 'Eureka', 
                                'Humboldt', 'Lander', 'Lincoln', 'Lyon', 'Mineral', 'Nye', 'Pershing', 'Storey', 'Washoe', 'White Pine'))

    elif state == 'NH':
        county = st.selectbox('Select your county', ('Belknap', 'Carroll', 'Cheshire', 'Coos', 'Grafton', 'Hillsborough', 'Merrimack', 
                                'Rockingham', 'Strafford', 'Sullivan'))

    elif state == 'NJ':
        county = st.selectbox('Select your county', ('Atlantic', 'Bergen', 'Burlington', 'Camden', 'Cape May', 'Cumberland', 'Essex', 
        ...
        county = st.selectbox('Select your county', ('Albany', 'Allegany', 'Bronx', 'Broome', 'Cattaraugus', 'Cayuga', 'Chautauqua', 
        ...
        county = st.selectbox('Select your county', ('Alamance', 'Alexander', 'Alleghany', 'Anson', 'Ashe', 'Avery', 'Beaufort', 'Bertie', 
        ...
        county = st.selectbox('Select your county', ('Adams', 'Barnes', 'Benson', 'Billings', 'Bottineau', 'Bowman', 'Burke', 'Burleigh', 
        ...
        county = st.selectbox('Select your county', ('Adams', 'Allen', 'Ashland', 'Ashtabula', 'Athens', 'Auglaize', 'Belmont', 'Brown', 
        ...
        county = st.selectbox('Select your county', ('Adair', 'Alfalfa', 'Atoka', 'Beaver', 'Beckham', 'Blaine', 'Bryan', 'Caddo',
        ...
        county = st.selectbox('Select your county', ('Baker', 'Benton', 'Clackamas', 'Clatsop', 'Columbia', 'Coos', 'Crook',
        ...
        county = st.selectbox('Select your county', ('Adams', 'Allegheny', 'Armstrong', 'Beaver', 'Bedford', 'Berks', 'Blair',
        ...
        county = st.selectbox('Select your county', ('Bristol', 'Kent', 'Newport', 'Providence', 'Washington'))

    elif state == 'SC':
        county = st.selectbox('Select your county', ('Abbeville', 'Aiken', 'Allendale', 'Anderson', 'Bamberg',
        ...
        county = st.selectbox('Select your county', ('Aurora', 'Beadle', 'Bennett', 'Bon Homme', 'Brookings', 'Brown',
        ...
        county = st.selectbox('Select your county', ('Anderson', 'Bedford', 'Benton', 'Bledsoe', 'Blount', 'Bradley', 
        ...
        county = st.selectbox('Select your county', ('Anderson', 'Andrews', 'Angelina', 'Aransas', 'Archer', 'Armstrong',
        ...
        county = st.selectbox('Select your county', ('Beaver', 'Box Elder', 'Cache', 'Carbon', 'Daggett',
        ...
        county = st.selectbox('Select your county', ('Addison', 'Bennington', 'Caledonia', 'Chittenden', 
                                'Essex', 'Franklin', 'Grand Isle', 'Lamoille', 'Orange', 'Orleans', 'Rutland',
                                'Washington', 'Windham', 'Windsor'))

    elif state == 'VA':
        county = st.selectbox('Select your county', ('Accomack', 'Albemarle', 'Alleghany', 'Amelia', 'Amherst', 
        ...
        county = st.selectbox('Select your county', ('Adams', 'Asotin', 'Benton', 'Chelan', 'Clallam',
        ...
        county = st.selectbox('Select your county', ('Barbour', 'Berkeley', 'Boone', 'Braxton', 'Brooke',
        ...
        county = st.selectbox('Select your county', ('Adams', 'Ashland', 'Barron', 'Bayfield', 'Brown',
        ...
        county = st.selectbox('Select your county', ('Albany', 'Big Horn', 'Campbell', 'Carbon', 'Converse', 'Crook',
    ...
    st.write(f"Your selected state is {state}, and your selected county is {county}")
